            ...
            <div class="row">
              <div class="col-6">
                ...
                <div class="mb-3">
                  ...
                  <input type="number" class="form-control" :id="'editarDocumentoCliente-' + siniestro.numeroSiniestro"
                    v-model="siniestro.documento" name="editarDocumentoCliente" :disabled="rolUsuario === 'Consulta'" />
                </div>
                <div class="mb-3">
