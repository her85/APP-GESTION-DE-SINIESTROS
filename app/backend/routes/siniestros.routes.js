...
router.put("/modificar_siniestro",limit, authenticateToken, authorizeRole(["Administrador", "Tramitador"]), [
    ...
    body('numeroPoliza').optional().notEmpty().trim(), 
    body('tipoDocumento').optional().notEmpty().trim(),
    body('documentoCliente').optional().notEmpty().trim(), 
    body('nombreCliente').optional().notEmpty().trim(),
    body('direccionCliente').optional().notEmpty().trim(),
    body('telefonoCliente').optional().notEmpty().trim(),
    body('mailCliente').optional().notEmpty().trim(), 
    body('tipoVehiculo').optional().notEmpty().trim(),
    body('patente').optional().notEmpty().trim(), 
    body('marca').optional().notEmpty().trim(),
    body('modelo').optional().notEmpty().trim(),
    body('anioFabricacion').optional().notEmpty().trim(), 
    body('numeroDeMotor').optional().notEmpty().trim(),
    body('numeroDeChasis').optional().notEmpty().trim(),
    body('tipoSiniestro').optional().notEmpty().trim(),
    body('fechaSiniestro').optional().notEmpty().trim(), 
    body('direccionSiniestro').optional().notEmpty().trim(),
    body('descripcionSiniestro').optional().notEmpty().trim(),
